...
from .views import DisplayOrderContentsView, AddProductToOrderView, AddCartToOrderView, DeleteOrderView , FeedBackView

urlpatterns = [
    path('contents/<int:user_id>/', DisplayOrderContentsView.as_view(), name='order_content'),
